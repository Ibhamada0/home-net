...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "سيس-نت | إدارة مايكروتيك" },
      { name: "description", content: "نظام احترافي بالعربية لإدارة راوترات مايكروتيك: مستخدمي PPPoE، الباقات، الفوترة، ومراقبة الشبكة." },
      { name: "theme-color", content: "#0F172A" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "سيس-نت" },
      { name: "mobile-web-app-capable", content: "yes" },
      { property: "og:title", content: "سيس-نت | إدارة مايكروتيك" },
      { property: "og:description", content: "إدارة مستخدمي PPPoE والهوت سبوت، الباقات والفواتير، ومراقبة الشبكة المباشرة." },
